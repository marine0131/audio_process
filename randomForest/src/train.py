...
sub1 = ["/opt/audio_process/audioAnalysis/feature_data/neg_20180424.log",
        ...
        "/opt/audio_process/audioAnalysis/feature_data/neg_20180615.log",
        "/opt/audio_process/audioAnalysis/feature_data/neg_20180615_1.log",
        # "/opt/audio_process/audioAnalysis/feature_data/neg_0404.log",
        # "/opt/audio_process/audioAnalysis/feature_data/neg_0411.log",
        # "/opt/audio_process/audioAnalysis/feature_data/neg_0416.log",
        # "/opt/audio_process/audioAnalysis/feature_data/neg_0417.log",
        # "/opt/audio_process/audioAnalysis/feature_data/neg_0418.log",
        "/opt/audio_process/audioAnalysis/feature_data/pos_20180601.log",
        "/opt/audio_process/audioAnalysis/feature_data/pos_20180615.log",
...
def detect(rf, log):
    ...
    for samp in detectList:
        resultLabel = testForest.classify(samp)
        print "1" if resultLabel=="positive" else "0"
